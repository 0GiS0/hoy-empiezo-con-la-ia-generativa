...
def conversation():
    ...
    Flujo:
      ...
      3) Añade el texto al historial y genera respuesta con Chat (texto+audio).
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(delete=False, suffix='.wav') as temp_input:
            ...
            # 1️⃣ Transcribir audio a texto usando Whisper
...
if __name__ == '__main__':
    ...
    console.print(f"[green]✅ Modelo de transcripción:[/green] [cyan]{os.getenv('TRANSCRIBE_MODEL', 'whisper-1')}[/cyan]")
    console.print(f"[green]✅ Modelo para audio (respuesta):[/green] [cyan]{os.getenv('MODEL_FOR_AUDIO', 'gpt-4o-audio-preview')}[/cyan]")
